...
BasicMackieHandler.prototype.updateChannel = function (index)
{
	...
	{			
		...
		channelInfo.setValue (channelElement, flipped ? "volume" : "pan");
...
BasicMackieHandler.prototype.onFaderTouched = function (channelIndex, value)
	{
		let channel = this.channels[channelIndex];

		//Host.GUI.alert("channel is: " + channel.channelElement + "\n" + "value is: " + value);

		if ( value )
			//channel.setValue (channel.channelElement, "volume");
			channel.setLabel (channel.channelElement, "volume");
		else
			channel.setLabel (channel.channelElement, "label");
